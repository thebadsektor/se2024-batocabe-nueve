...
$Sem=$_POST['Sem'];
$Dept=$_POST['Dept'];
$sql="insert into tblsubjects(Subject,SemId,DeptId) values(:subjects,:Sem,:Dept)";
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group"><label for="company" class=" form-control-label">Semester ID</label><input type="text" name="Sem" value="" class="form-control" id="Sem" required="true"></div>
                                <div class="form-group"><label for="company" class=" form-control-label">Department ID</label><input type="text" name="Dept" value="" class="form-control" id="Dept" required="true"></div>
